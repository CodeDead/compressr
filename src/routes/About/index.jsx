        ...
        <Container size="sm" className={classes.wrapper}>
          ...
          <Accordion variant="separated">
            <Accordion.Item className={classes.item} value="reset-password">
              ...
              <Accordion.Panel>
                Yes! If you set the compression level to 0, your images will be very
                pixelated.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item className={classes.item} value="another-account">
              ...
              <Accordion.Panel>
                No. Compression is entirely done on your own device and your images
                do not pass our servers.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item className={classes.item} value="payment">
              ...
              <Accordion.Panel>
                There is no maximum file size since the compression is done on your
                own device. If you have a very large image, the compression process
                might take a while. We&apos;re currently working on a solution to
